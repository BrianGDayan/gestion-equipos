...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-20 z-50 flex items-center justify-between bg-primary px-6 shadow-md border-b border-primary-dark">
      ...
      <div className="flex items-center gap-6">
        ...
        {/* TÍTULO DEL SISTEMA (Más grande y notorio) */}
      ...
      <div className="flex items-center gap-4">
        <button className="relative p-2 text-white hover:bg-white/10 rounded-full transition-colors">
          <Bell className="h-6 w-6" /> {/* Icono un poco más grande */}
          <span className="absolute top-1.5 right-1.5 h-2.5 w-2.5 rounded-full bg-red-500 border-2 border-primary" />
        </button>
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-xs text-blue-100 opacity-90 mt-1">Sesión Activa</p>
          </div>
